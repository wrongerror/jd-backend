...
import json
from apps.aliyun.api.gateway.sdk.util import UUIDUtil, DateUtil
from apps.aliyun.api.gateway.sdk.http.request import Request
from apps.aliyun.api.gateway.sdk.http.response import Response
from apps.aliyun.api.gateway.sdk.common import constant
from apps.aliyun.api.gateway.sdk.auth import md5_tool, signature_composer, sha_hmac256
...
class DefaultClient:
    ...
    def build_headers(self, request=None):
        ...
        print(str_to_sign)
        headers[constant.X_CA_SIGNATURE] = sha_hmac256.sign(str_to_sign.encode('utf-8'), self.__app_secret)
